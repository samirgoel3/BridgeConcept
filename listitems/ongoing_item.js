...
class Ongointitem extends Component {
  state = {};
  render() {
    return (
      <View style={styles.s0180da6b}>
        ...
        <View style={styles.s3522ae48}>
          ...
          />
          <Text style={styles.s771762be}>Driver name goes here</Text>
          <Text style={styles.s92618221}>+919989874365</Text>
          <Text style={styles.s569e22ca}>Trip Status</Text>
        </View>
